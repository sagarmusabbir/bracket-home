    ...
    <div className="min-h-screen bg-conic from-slate-200 via-slate-50 to-slate-200 to-75% dark:bg-conic dark:from-gray-800 dark:via-slate-900 dark:to-gray-800 dark:to-90%">
      <header className="bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm border-b border-slate-200/50 dark:border-slate-700/50 p-4">
        <div className="container mx-auto flex justify-between items-center">
          <Link href="/dashboard" className="text-gray-700 dark:text-slate-300 hover:text-gray-900 dark:hover:text-white transition-colors flex items-center">
          ...
          <h1 className="text-xl font-bold text-gray-700 dark:text-slate-300">Media Gallery</h1>
      ...
      <div className="fixed bottom-6 right-6">
        <Link 
          href="/upload"
          className="bg-conic from-slate-600 via-gray-700 to-slate-600 hover:from-gray-700 hover:via-slate-800 hover:to-gray-700 dark:from-slate-600 dark:via-gray-600 dark:to-slate-600 text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg"
        >
